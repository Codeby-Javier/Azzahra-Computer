			    				...
			    				<tr>
				    				...
				    				<td class="text-center">
				    					<div class="flex sm:justify-center items-center">
				    						...
				    						<?php if($row['trans_status'] == 'Pelunasan'): ?>
				    							<a href="<?= site_url('Service/cari/'.$row['trans_kode'])?>" class="button px-2 mr-1 mb-2 bg-blue-500 text-white">
				    								<span class="w-5 h-5 flex items-center justify-center"> <i data-feather="credit-card" class="w-4 h-4"></i> </span>
				    							</a>
				    						<?php endif; ?>
